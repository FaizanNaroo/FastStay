        ...
        <>
            ...
            <div className={styles.container}>
                ...
                <div style={{ background: '#f8f3e7', borderRadius: '16px', boxShadow: '0 6px 20px rgba(0,0,0,0.22)', marginBottom: '24px', overflow: 'hidden' }}>
                    ...
                    <div className={styles.stuOverviewGrid}>
                        {/* Total */}
                ...
                {/* SEARCH + FILTER BAR */}
                <div className={styles.stuFilterBar} style={{ display: 'flex', alignItems: 'center', marginBottom: '20px', gap: '8px' }}>
                    <input
                        type="text"
                    ...
                    <button
                        ...
                        disabled={!search && cityFilter === 'All' && genderFilter === 'All'}
                        style={{
                            padding: '8px 14px',
                            backgroundColor: (search || cityFilter !== 'All' || genderFilter !== 'All') ? '#e74c3c' : '#ddd',
                            color: (search || cityFilter !== 'All' || genderFilter !== 'All') ? 'white' : '#999',
                            border: 'none', borderRadius: '6px',
                            cursor: (search || cityFilter !== 'All' || genderFilter !== 'All') ? 'pointer' : 'default',
                ...
                <div style={{ background: '#f8f3e7', borderRadius: '16px', boxShadow: '0 6px 20px rgba(0,0,0,0.22)', marginBottom: '28px', overflow: 'hidden' }}>
                    ...
                    {/* Column headers */}
                    <div className={styles.stuColHeader} style={{
                        padding: '8px 32px', background: '#f0f5fb', borderBottom: '1px solid #d0e4f7',
                    ...
                    {loading ? (
                        ...
                        filteredStudents.map((s) => (
                            <div key={s.id}
                                className={styles.stuGridRow}
                                onMouseEnter={e => (e.currentTarget.style.background = '#f0f5fb')}
                                onMouseLeave={e => (e.currentTarget.style.background = '')}
                            >
                                {/* Avatar + Name */}
                                <div className={styles.stuCellName} style={{ display: 'flex', alignItems: 'center', gap: '12px', minWidth: 0 }}>
                                ...
                                {/* Age */}
                                <div className={styles.stuCellAge}>
                                    <span style={{
                                ...
                                {/* City */}
                                <div className={styles.stuCellCity}>
                                ...
                                {/* Gender */}
                                <div className={styles.stuCellGender}>
                                    <span style={{
                                ...
                                {/* Action */}
                                <div className={styles.stuCellAction} style={{ textAlign: 'right' }}>
