...
from ..utils.Return_Codes import RETURN_CODES

def Mess_Detail_service(data, operation='add'):
    """
    'add' -> Add mess Details
    'Update' -> Update Mess Detail
    """

    try:
        function_name = 'AddMessDetails'  if operation == 'add' else 'UpdateMessDetails'
