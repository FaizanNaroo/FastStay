...
from faststay_app.services.Delete_Mess_Details_service import Delete_Mess_Detail_service
from faststay_app.serializers.Delete_Mess_Details_Serializer import Delete_Mess_Details_Serializer
