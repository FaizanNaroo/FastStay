...
import json
from faststay_app.services.display_service.details_kitchen import DetailsKitchen
from django.views.decorators.csrf import csrf_exempt
from django.utils.decorators import method_decorator


@method_decorator(csrf_exempt, name='dispatch')
class DetailsKitchen(View):
    hostel_service = DetailsKitchen()
    ...
    def get(self, request, *args, **kwargs):
        ...
        try:
            info_list = self.hostel_service.details_kitchen(hostel_id)
            if info_list:
