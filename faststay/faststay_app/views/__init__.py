...
from .Student_views import Student_Detail_Entry_view, Update_Student_Detail_view, Display_All_Students_View, Display_Student_View
...
__all__ = [
    ...
    "Student_Detail_Entry_view", "Update_Student_Detail_view", "Display_All_Students_View", "Display_Student_View",
    "SignupView",
